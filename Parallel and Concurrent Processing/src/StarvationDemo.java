...
public class StarvationDemo {
    public static void main(String[] args) {
        ...
        for (int i=0; i<5000; i++) {
            new Philosopher("Barron", chopstickA, chopstickB).start(); // same priority given to all mutex locks.
            new Philosopher("Olivia", chopstickA, chopstickB).start(); // all philosophers (threads) will try to acquire chopstick A first.
