...
class ChefOlivia extends Thread { //custom thread class inherit from Thread class
    @Override //overriding default thread run method.
    public void run() {
...
public class ThreadLifecycleDemo {
    public static void main(String[] args) throws InterruptedException { //main method represents Barron
        System.out.println("Barron started & requesting Olivia's help.");
        Thread olivia = new ChefOlivia(); //using ChefOlivia constructor method to create new thread
